...
const CategoryList = () => {
    ...
    const remove = async(id) => {
        axios.delete(`category/${id}/`, settingCredentialsConfig)
        .then(res => {
        ...
        <div>
            ...
            <div>
                <canvas className="my-4 w-100" id="myChart" width="900" height="20"></canvas>
                    <h2>Category</h2>
                    <Link to='/categories/create'  className="w-10 btn btn-primary" style={{borderRadius: '2rem', width: '200px'}} >New</Link>
                                ...
                                {categories.map(category => {
                                    return (
                                        <tr key={category.id}>
                                            ...
                                            <td>
                                                <a href="#"  onClick={() => remove(category.id)} >
